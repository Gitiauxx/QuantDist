...
../fvae-env/bin/python3 genetic_algorithm/GeneticAlgorithm.py --depth 9 --num_ancillas 6 --seed $SLURM_ARRAY_TASK_ID --num_iterations 1000 --run run1  --num_inputs 8 --gen_size 1000
